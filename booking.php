...
<li><img src="images/logo2.png" style="padding-left:5px;padding-right:10px;padding-top:10px;float:left;height:35px;width:250px"></li>
		...
		<tr>
			...
			<td width="50%">
				...
				<select  required  style="width:100%; height:30px " name="mov">
					...
					{
					if($data['Release_date']<="2021-05-15")
					{						
					?>
